...
describe('OrdersTable Responsive Design', () => {
  ...
  it('should render desktop table on large screens', () => {
    ...
    expect(screen.getAllByText('Estado')).toHaveLength(2); // Header and filter label
    expect(screen.getByText('País')).toBeInTheDocument();
  });

  it('should render mobile cards view', () => {
    render(<OrdersTable orders={[mockOrder]} />);
    ...
    // Should show order information in both desktop and mobile views
    expect(screen.getAllByText('ST001')).toHaveLength(2); // Desktop + mobile
