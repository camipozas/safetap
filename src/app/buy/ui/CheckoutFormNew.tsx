  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
      ...
      <div>
        ...
        {/* Important Notice about identical stickers */}
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-amber-800">
                <span className="font-semibold">Importante:</span> Todos los
                stickers de esta compra tendrán el mismo diseño (nombre, bandera
                y colores). Si necesitas stickers con diseños diferentes,
                realiza compras separadas.
              </p>
            </div>
          </div>
        </div>
