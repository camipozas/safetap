...
export default function DevLoginPage() {
  ...
  const [result, setResult] = useState<DevLoginResult | null>(null);
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-slate-600">
          Login rápido para pruebas sin configuración de email
        </p>
      </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-yellow-700 text-sm">
              Esta herramienta te permite autenticarte instantáneamente sin
              configurar email. Útil para probar todas las funcionalidades de la
              aplicación.
            </p>
          </div>
        </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
        ...
        <ol className="text-blue-700 space-y-2 list-decimal list-inside">
          <li>
            Ingresa cualquier email (se creará automáticamente si no existe)
          </li>
          <li>Haz click en Crear sesión de desarrollo</li>
          <li>Haz click en Iniciar sesión automáticamente</li>
          <li>
            Serás redirigido a tu cuenta en{' '}
            <code className="bg-blue-100 px-1 rounded">/account</code>
          </li>
        ...
        <div className="mt-4 pt-4 border-t border-blue-200">
          ...
          <ul className="text-blue-700 text-sm space-y-1 list-disc list-inside ml-4">
            <li>
              Comprar stickers en{' '}
              <code className="bg-blue-100 px-1 rounded">/buy</code>
            </li>
            <li>
              Crear perfiles de emergencia en{' '}
              <code className="bg-blue-100 px-1 rounded">/profile/new</code>
            </li>
            <li>
              Ver perfiles públicos en{' '}
              <code className="bg-blue-100 px-1 rounded">/s/[slug]</code>
            </li>
            <li>
              Gestionar tu cuenta en{' '}
              <code className="bg-blue-100 px-1 rounded">/account</code>
            </li>
          </ul>
        </div>
