      ...
      <body className={inter.className}>
        <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
          <div className="container flex h-16 items-center justify-between">
            <Link href="/" className="font-bold text-xl text-brand flex items-center" aria-label="Inicio safetap">
          ...
          <div className="container py-12">
            <div className="grid md:grid-cols-4 gap-8">
              <div className="md:col-span-2">
                ...
                <p className="text-slate-400 max-w-md">
                  Tu información vital siempre contigo. Tecnología que salva vidas.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-slate-400">
                  <li><Link href="/buy" className="hover:text-white transition-colors">Comprar sticker</Link></li>
                  <li><Link href="/s/demo" className="hover:text-white transition-colors">Ver ejemplo</Link></li>
                </ul>
              </div>
            ...
            <div className="border-t border-slate-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
              <p className="text-slate-400 text-sm">
                © {new Date().getFullYear()} safetap. Todos los derechos reservados.
              </p>
